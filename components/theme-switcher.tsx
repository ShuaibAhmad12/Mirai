    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size={"sm"}>
          {theme === "light" ? (
            ...
            <Palette key="pastel" size={ICON_SIZE} className={"text-muted-foreground"} />
          ) : (
      ...
      <DropdownMenuContent className="w-content" align="start">
        <DropdownMenuRadioGroup value={theme} onValueChange={(value) => setTheme(value)}>
          ...
          <DropdownMenuRadioItem className="flex gap-2" value="pastel">
            <Palette size={ICON_SIZE} className="text-muted-foreground" /> <span>Pastel</span>
          </DropdownMenuRadioItem>
